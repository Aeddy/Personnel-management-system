...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		...
		<form action="<%=pageContext.getServletContext().getContextPath() %>/use/login.action" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="<%=pageContext.getServletContext().getContextPath() %>/js/metronic/img/profile/logo2.jpg" alt="">
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2018 @哈尔滨工程大学  http://www.fkit.org
			</div>
		</form>
	</div>
