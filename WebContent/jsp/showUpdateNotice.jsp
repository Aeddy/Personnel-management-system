	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：公告管理  &gt;  修改公告</td>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
			    <form id="noticeForm" name="noticeForm" action="<%=pageContext.getServletContext().getContextPath() %>/notice/updateNotice.action" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
    	 			<input type="hidden" name="flag" value="2">
    	 			<input type="hidden" name="notice_id" value="${notice.notice_id }">
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    <tr><td class="font3 fftd">
					                公告标题：<input type="text" name="notice_title" size="30" id="notice_title" value="${notice.notice_title }"/>
						...
						<tr><td class="font3 fftd">公告内容：<br/>
							<textarea name="notice_content" cols="88" rows="11" id="notice_content" >${notice.notice_content }</textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
