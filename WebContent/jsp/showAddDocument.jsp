	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理  &gt; 上传文档
</td>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="<%=pageContext.getServletContext().getContextPath() %>/document/addDocument.action" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    ...
					    <tr><td class="font3 fftd">
					                ...
					                文档标题：<input type="text" name="document_title" size="30" id="document_title"/></td>
					    </tr>
