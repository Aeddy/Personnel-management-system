...
<html>
	...
	$(function(){
		// 控制文档加载完成以后 选中性别 
		$("#employee_sex").val("${employee.employee_sex}");
		$("#job_id").val("${employee.job.job_id}");
		$("#dept_id").val("${employee.dept.dept_id}");
    	/** 员工表单提交 */
		$("#employeeForm").submit(function(){
			...
			card_id.focus();
				...
				!/^\d{4}-\d{2}-\d{2}$/.test($.trim(employee_birthday.val()))
				msg = "出生日期格式不正确！";
				employee_birthday.focus();
			...
			}else if ($.trim(employee_hobby.val()) == ""){
				msg = "爱好不能为空！";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：员工管理  &gt; 修改员工</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="<%=pageContext.getServletContext().getContextPath() %>/employee/updateEmployee.action" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="employee_name" id="employee_name" size="20" value="${employee.employee_name }"/></td>
		    		...
		    		<tr>
		    			<td class="font3 fftd">性别：
								<select id="employee_sex" name="employee_sex" style="width:143px;">
		    		...
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="employee_education" id="employee_education" size="20" value="${employee.employee_education }"/></td>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="employee_email" id="employee_email" size="20" value="${employee.employee_email }"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="employee_phone" id="employee_phone" size="20" value="${employee.employee_phone }"/></td>
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="employee_tel" id="employee_tel" size="20" value="${employee.employee_tel }"/></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="employee_party" id="employee_party" size="40" value="${employee.employee_party }"/>&nbsp;&nbsp;
					QQ&nbsp;&nbsp;号码：<input name="employee_qqnum" id="employee_qqnum" size="20" value="${employee.employee_qqnum }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					联系地址：<input name="employee_address" id="employee_address" size="40" value="${employee.employee_address }"/>&nbsp;&nbsp;
					邮政编码：<input name="employee_postcode" id="employee_postcode" size="20" value="${employee.employee_postcode }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					name="employee_birthday" id="employee_birthday" value="${dt}" size="40"/>&nbsp;&nbsp;
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="employee_race" id="employee_race" size="20" value="${employee.employee_race }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					所学专业：<input  name="employee_speciality" id="employee_speciality" size="40" value="${employee.employee_speciality }"/>&nbsp;&nbsp;
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="employee_hobby" id="employee_hobby" size="20" value="${employee.employee_hobby }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					备&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="employee_remark" id="employee_remark" size="40" value="${employee.employee_remark }"/>
					&nbsp;&nbsp;所属部门：
					<select id="dept_id" name="dept.dept_id" style="width:100px;">
						   <option value="0">--部门选择--</option>
						   <c:forEach items="${requestScope.depts }" var="dept">
						   		<c:choose>
			    					<c:when test="${employee.dept.dept_id == dept.dept_id }">
