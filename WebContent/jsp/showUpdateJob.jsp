...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：职位管理  &gt; 修改职位</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="<%=pageContext.getServletContext().getContextPath() %>/job/updateJob.action" id="jobForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="job_name" id="job_name" size="20" value="${job.job_name }"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="job_remark" id="job_remark" size="20" value="${job.job_remark }"/></td>
		    		</tr>
