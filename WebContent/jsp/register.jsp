...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body  background="<%=pageContext.getServletContext().getContextPath() %>/images/loginback.jpg"
style= "background-repeat:no-repeat;backgound-size:100% 100%;backgroud-attachment:fixed;">
<img src="<%=pageContext.getServletContext().getContextPath() %>/images/register.jpg" alt=""> 
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				...
				style="font-size: 13px;">1.0</span> 系统 注册界面
			</a>
		</div>
		<form action="<%=pageContext.getServletContext().getContextPath() %>/user/Register.action" method="post" id="register">
			<%-- <span>&nbsp;</span>
			...
			<div class="page-body">
				...
				<div class="page-lock-info">
					...
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px;color:#FF00CC">允许以中文名称为账号</span>
						</c:when>
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user"></i> <input
									class="m-wrap placeholder-no-fix" type="text" placeholder="用户姓名"
									id="user_name" name="user_name" value="${user_nname}">
							</div>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									class="m-wrap placeholder-no-fix" type="password"
									placeholder="确认密码" id="user_passwordTwo" name="user_passwordTwo"
									value="${user_password}">
							</div>
						</div>
					</div>
				...
				<div class="relogin">
						...
						<!-- 返回上一页 -->
						<input type="hidden" <a href="<%=pageContext.getServletContext().getContextPath() %>/jsp/loginForm.jsp" type="submit" id="logn-submit-btn" class="btn green"
			...
			<div class="page-footer" style="color: #FFFFFF">
