...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=pageContext.getServletContext().getContextPath() %>/js/tiny_mce/tiny_mce.js"></script>
		<script type="text/javascript" src="<%=pageContext.getServletContext().getContextPath() %>/js/jquery.form.js"></script>
	    ...
	    $(document).ready(function() {
	        ...
	        $("#btn").click(function(){
	        	...
	        	if($.trim(document_title).length <= 2){
	        		alert("请输入两个字符以上的标题");
	        		return ;
	        	}
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理  &gt; 修改文档
</td>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="<%=pageContext.getServletContext().getContextPath() %>/document/updateDocument.action" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    ...
					    <tr><td class="font3 fftd">
					                ...
					                文档标题：<input type="text" name="document_title" size="30" id="document_title" value="${document.document_title }"/></td>
					    </tr>
