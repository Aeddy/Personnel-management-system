	...
	<script type="text/javascript">
	 $(function(){
			...
			$("#deptForm").submit(function(){
				...
				var dept_remark = $("#dept_remark");
				var msg = "";
				if ($.trim(dept_name.val()) == ""){
					msg = "部门名称不能为空！";
					dept_name.focus();
				}else if ($.trim(dept_remark.val()) == ""){
					msg = "详细描述不能为空！";
					dept_remark.focus();
				}
				if (msg != ""){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：部门管理  &gt; 修改部门</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="<%=pageContext.getServletContext().getContextPath() %>/dept/updateDept.action" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="dept_name" id="dept_name" size="20" value="${dept.dept_name }"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="dept_remark" id="dept_remark" size="20" value="${dept.dept_remark }"/></td>
		    		</tr>
