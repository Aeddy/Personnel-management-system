...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="<%=pageContext.getServletContext().getContextPath() %>/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：用户管理  &gt; 修改用户</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="<%=pageContext.getServletContext().getContextPath() %>/user/updateUser.action" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="user_name" id="user_name" size="20" value="${user.user_name }"/></td>
		    			<td class="font3 fftd">状态：<input type="text" name="user_status" id="user_status" size="20" value="${user.user_status }"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="user_loginname" id="user_loginname" size="20" value="${user.user_loginname }"/></td>
		    			<td class="font3 fftd">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input name="user_password" id="user_password" size="20" value="${user.user_password }"/></td>
		    		</tr>
